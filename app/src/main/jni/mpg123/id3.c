...
// Fix for running NDK apps compiled with platform-21 running on pre-5.0 devices
// See: https://groups.google.com/forum/#!topic/android-ndk/RjO9WmG9pfE
static inline double atof_fix(const char *nptr)
{
	return (strtod(nptr, NULL));
}
#define atof atof_fix
